...
.tdroot .settings-popover .sp-section{padding:16px 18px;border-bottom:1px solid #ece8dc;background:#E7EAEC;}
...
.tdroot .settings-popover .sp-meta{font-size:12px;color:#6b6455;margin:0 0 10px;}
.tdroot .settings-popover .sp-btns{display:flex;gap:8px;}
.tdroot .settings-popover .sp-btn{background:var(--dark-blue);color:#fff;border:none;border-radius:8px;padding:7px 14px;font-size:12.5px;font-weight:600;cursor:pointer;font-family:inherit;transition:filter .15s,transform .1s;}
.tdroot .settings-popover .sp-btn:hover:not(:disabled){filter:brightness(1.1);transform:translateY(-1px);}
.tdroot .settings-popover .sp-btn:active:not(:disabled){transform:translateY(0);}
.tdroot .settings-popover .sp-btn:disabled{opacity:.5;cursor:default;}
.tdroot .settings-popover .sp-btn.sp-outline{background:transparent;color:var(--dark-blue);border:1.5px solid var(--dark-blue);}
.tdroot .settings-popover .sp-btn.sp-outline:hover:not(:disabled){background:rgba(95,160,158,.08);}
.tdroot .settings-popover .sp-restore-list{margin-top:10px;max-height:170px;overflow-y:auto;border:1px solid #ece8dc;border-radius:8px;}
.tdroot .settings-popover .sp-restore-list::-webkit-scrollbar{width:6px}
.tdroot .settings-popover .sp-restore-list::-webkit-scrollbar-thumb{background:#cfcabb;border-radius:4px}
.tdroot .settings-popover .sp-restore-row{display:flex;align-items:center;padding:7px 10px;border-bottom:1px solid #f4f2ea;font-size:12px;transition:background .1s;}
.tdroot .settings-popover .sp-restore-row:last-child{border-bottom:none;}
.tdroot .settings-popover .sp-restore-row:hover{background:#f7f5f0;}
...
.tdroot .settings-popover .sp-restore-row .sp-rbtn{background:var(--dark-blue);color:#fff;border:none;border-radius:6px;padding:3px 10px;font-size:11px;font-weight:600;cursor:pointer;flex:none;transition:filter .15s;}
.tdroot .settings-popover .sp-restore-row .sp-rbtn:hover{filter:brightness(1.1);}
