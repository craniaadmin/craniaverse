/* THROWAWAY verification harness — deleted before the turn ends. Renders
   the settings popover on its own, against a stubbed backups endpoint, so
   the shared panel can be measured without signing in. */
...
function Harness() {
  useEffect(() => {
    const t = setTimeout(() => document.querySelector('.pgacts .gearbtn')?.click(), 50)
