...
window.fetch = async (input) => {
  ...
  if (path === '/api/todo') return json({
    lists: [{ id: 'L1', name: 'Products' }],
    items: [
      { id: 't1', listId: 'L1', text: 'Edit IE agenda', done: false, priority: 'high' },
      { id: 't2', listId: 'L1', text: 'Make Agenda Sales Website', done: false, priority: 'high' },
    ],
    checklists: [],
  })
